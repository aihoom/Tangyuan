...
if (!class_exists('Puc_v4p4_Plugin_UpdateChecker', false)):
    ...
    class Puc_v4p4_Plugin_UpdateChecker extends Puc_v4p4_UpdateChecker
    {
         ...
         * @param int    $checkPeriod  How often to check for updates (in hours). Defaults to checking every 12 hours. Set to 0 to disable automatic update checks.
        ...
        public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            if ((false === strpbrk($this->pluginFile, '/\\')) && $this->isUnknownMuPlugin()) {
        ...
        {
            $relevant = ('plugin_information' == $action) && isset($args->slug) && (
