...
<li>
    <a class="article-media" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"
        style="background-image: url(<?php echo $article_media_source; ?>) ">
